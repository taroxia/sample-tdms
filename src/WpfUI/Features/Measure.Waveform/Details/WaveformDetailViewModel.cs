...
namespace WpfUI.Features.Measure.Waveform.Details;

public record MetricRow(string PropertyName, string Value);

public sealed class WaveformDetailViewModel : ViewModelBase
{
    ...
    public WaveformDetailViewModel(WaveformService service)
    {
